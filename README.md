...
# Responsive Web Design Certification #12 | Cat Painting

## 1️⃣ Objetivo
Criar o rosto de um gato utilizando a propriedade *position*, explorando técnicas avançadas de posicionamento no CSS.

## 2️⃣ Descrição
Este é o 12º curso da trilha **Responsive Web Design Certification**, que substitui o projeto anterior inspirado na obra *Three Musicians* de Pablo Picasso (1881–1973).

Apesar da mudança no tema, o foco principal permanece: dominar a propriedade *position* e reforçar conceitos essenciais do CSS para construção de layouts precisos e originais.

A principal diferença em relação ao curso anterior é a introdução de uma nova propriedade:
